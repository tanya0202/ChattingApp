...
public class Server  implements ActionListener {
	...
	Server()
	{
		...
		ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("chatting/application/icons/harry.jpg"));
	...
	public static JPanel formatLabel(String out)
	{
		...
		l1.setBackground(new Color(153,153,153));
		l1.setOpaque(true);
